 ...
 * @since 2.0
 */
public class EigenDecompositionImpl_bug5 implements EigenDecomposition {
     ...
     */
    public EigenDecompositionImpl_bug5(final RealMatrix matrix,
     ...
     * if algorithm fails to converge
     */
    public EigenDecompositionImpl_bug5(final double[] main, double[] secondary,
            final double splitTolerance)
        throws InvalidMatrixException {
        ...
        for (boolean deflating = true; deflating;) {
            ...
            if ((start == deflatedEnd - 1) ||
                ...
                if (work[k - 5] > TOLERANCE_2 * work[k - 3]) {
                    ...
                    work[k - 3] =work[k - 3] * (work[k - 7] / t);//buggy6 + small number
                    work[k - 7]  = t;
                }
