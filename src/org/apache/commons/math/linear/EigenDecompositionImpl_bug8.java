 ...
 * @since 2.0
 */
public class EigenDecompositionImpl_bug8 implements EigenDecomposition {
     ...
     */
    public EigenDecompositionImpl_bug8(final RealMatrix matrix,
     ...
     * if algorithm fails to converge
     */
    public EigenDecompositionImpl_bug8(final double[] main, double[] secondary,
            final double splitTolerance)
        throws InvalidMatrixException {
