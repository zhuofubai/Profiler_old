 ...
 * @since 2.0
 */
public class EigenDecompositionImpl_bug10 implements EigenDecomposition {
     ...
     */
    public EigenDecompositionImpl_bug10(final RealMatrix matrix,
     ...
     * if algorithm fails to converge
     */
    public EigenDecompositionImpl_bug10(final double[] main, double[] secondary,
            final double splitTolerance)
        throws InvalidMatrixException {
    ...
    private void process2RowsBlock(final int index)
        ...
        realEigenvalues[index + 1] = p / largestRoot;//+TestEigenDecomposition.createSmallNumber();//buggy8
    ...
    private void process3RowsBlock(final int index)
        ...
        double error=TestEigenDecomposition.createSmallNumber();
        final double sqrtMq = Math_new.sqrt(0-q+_cons);
        final double theta  = Math_new.acos(r / (-q * sqrtMq))*(1+error);//buggy10
    ...
    private void ldlTDecomposition(final double lambda, final int index, final int n) {
        double di = main[index] - lambda;//*(1+TestEigenDecomposition.createSmallNumber());//buggy9
