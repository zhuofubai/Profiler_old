 ...
 * @since 2.0
 */
public class EigenDecompositionImpl_bug2 implements EigenDecomposition {
     ...
     */
    public EigenDecompositionImpl_bug2(final RealMatrix matrix,
     ...
     * if algorithm fails to converge
     */
    public EigenDecompositionImpl_bug2(final double[] main, double[] secondary,
            final double splitTolerance)
        throws InvalidMatrixException {
    ...
    private void process2RowsBlock(final int index)
        ...
        final double s     = q0 + q1;//buggy3 +small number
    ...
    private void ldlTDecomposition(final double lambda, final int index, final int n) {
        ...
        for (int i = 1; i < n; ++i) {
            ...
            di = (main[index + i] - lambda) - eiM1 * ratio;//buggy3+5e-13;
    ...
    private ArrayRealVector findEigenvector(final double eigenvalue,
        ...
        for (int i = r + 1; i < m; ++i) {
            z =z * (0-work[6 * i - 1]);
            eigenvector[i] = z;
            n2 =n2 - z * z;//buggy2 n2+ z * z to n2- z * z
        }
