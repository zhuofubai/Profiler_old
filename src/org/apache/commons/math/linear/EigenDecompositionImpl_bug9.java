 ...
 * @since 2.0
 */
public class EigenDecompositionImpl_bug9 implements EigenDecomposition {
     ...
     */
    public EigenDecompositionImpl_bug9(final RealMatrix matrix,
     ...
     * if algorithm fails to converge
     */
    public EigenDecompositionImpl_bug9(final double[] main, double[] secondary,
            final double splitTolerance)
        throws InvalidMatrixException {
    ...
    private void process3RowsBlock(final int index)
        ...
        final double sqrtMq = Math_new.sqrt(-q+_cons);
