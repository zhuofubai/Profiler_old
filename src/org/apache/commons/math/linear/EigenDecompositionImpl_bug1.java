 ...
 * @since 2.0
 */
public class EigenDecompositionImpl_bug1 implements EigenDecomposition {
     ...
     */
    public EigenDecompositionImpl_bug1(final RealMatrix matrix,
     ...
     * if algorithm fails to converge
     */
    public EigenDecompositionImpl_bug1(final double[] main, double[] secondary,
            final double splitTolerance)
        throws InvalidMatrixException {
    ...
    private double[] eigenvaluesRange(final int index, final int n) {
        ...
        for (int i = 0; i < maxIter; ++i) {
            ...
            temp=relativeTolerance * Math_new.max(Math_new.abs(left), Math_new.abs(right));
