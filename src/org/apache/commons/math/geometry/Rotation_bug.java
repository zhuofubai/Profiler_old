 ...
 * class provides the methods: {@link #applyTo(Rotation_bug) applyTo(Rotation)} and
 * {@link #applyInverseTo(Rotation_bug) applyInverseTo(Rotation)}.</p>
 *
...
public class Rotation_bug implements Serializable {

  /** Identity rotation. */
  public static final Rotation_bug IDENTITY = new Rotation_bug(1.0, 0.0, 0.0, 0.0, false);
   ...
   * before using them
   */
  public Rotation_bug(double q0, double q1, double q2, double q3,
   ...
   */
  public Rotation_bug(Vector3D axis, double angle) {
   ...
   */
  public Rotation_bug(double[][] m, double threshold)
   ...
   */
  public Rotation_bug(Vector3D u1, Vector3D u2, Vector3D v1, Vector3D v2) {
   ...
   * @exception IllegalArgumentException if the norm of one of the vectors is zero
   */
  public Rotation_bug(Vector3D u, Vector3D v) {
   ...
   */
  public Rotation_bug(RotationOrder order,
                  double alpha1, double alpha2, double alpha3) {
    Rotation_bug r1 = new Rotation_bug(order.getA1(), alpha1);
    Rotation_bug r2 = new Rotation_bug(order.getA2(), alpha2);
    Rotation_bug r3 = new Rotation_bug(order.getA3(), alpha3);
    Rotation_bug composed = r1.applyTo(r2.applyTo(r3));
    q0 = composed.q0;
    q1 = composed.q1;
    q2 = composed.q2;
    q3 = composed.q3;
   ...
   * of the instance
   */
  public Rotation_bug revert() {
    return new Rotation_bug(-q0, q1, q2, q3, false);
  }
   ...
   */
  public Rotation_bug applyTo(Rotation_bug r) {
    return new Rotation_bug(r.q0 * q0 - (r.q1 * q1 + r.q2 * q2 + r.q3 * q3),
   ...
   * of the instance
   */
  public Rotation_bug applyInverseTo(Rotation_bug r) {
    return new Rotation_bug(-r.q0 * q0 - (r.q1 * q1 + r.q2 * q2 + r.q3 * q3),
                        -r.q1 * q0 + r.q0 * q1 + (r.q2 * q3 - r.q3 * q2),
                        -r.q2 * q0 + r.q0 * q2 + (r.q3 * q1 - r.q1 * q3),
                        -r.q3 * q0 + r.q0 * q3 + (r.q1 * q2 - r.q2 * q1),
   ...
   */
  public static double distance(Rotation_bug r1, Rotation_bug r2) {
